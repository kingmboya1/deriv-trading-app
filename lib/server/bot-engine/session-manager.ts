...
export class SessionManager {
   ...
   */
  private static sessions: Map<string, BotEngine> = new Map();
   ...
   */
  private static userSessions: Map<string, string> = new Map();
   ...
   */
  static createSession(userId: string, engine: BotEngine): string {
   ...
   */
  static getSession(sessionId: string): BotEngine | null {
   ...
   */
  static getUserSession(userId: string): string | null {
